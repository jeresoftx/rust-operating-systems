...
desarrollados: procesos e hilos, mutex, semáforos, memoria, scheduling y
paging. La siguiente línea natural es continuar con memoria virtual sin perder
la anatomía completa de RFC-0001 §14.
